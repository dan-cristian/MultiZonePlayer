...
namespace MultiZonePlayer
{
    ...
    public class WindowsEnumerator
    {
        ...
        public static int GetWindowHandleByTitle(String title)
        {
            int appHandle;
            ...
            WindowsEnumerator enumerator = new WindowsEnumerator();
                    foreach (ApiWindow top in enumerator.GetTopLevelWindows())
                    {
                        //MLog.Log(null,"top="+top.MainWindowTitle);
                        if (top.MainWindowTitle.Contains(title))
                        {
                            appHandle = top.hWnd;
                            return appHandle;
                        }
                        ...
                        foreach (ApiWindow child in enumerator.GetChildWindows(top.hWnd))
                        {
                            MLog.Log(null,"child=" + child.MainWindowTitle);
                            if (child.MainWindowTitle.Contains(title))
                            {
                                appHandle = child.hWnd;
                                MLog.Log(null,"found child= " + child.MainWindowTitle + child.ClassName);
                                return appHandle;
                            }
                        }*/
                    }
