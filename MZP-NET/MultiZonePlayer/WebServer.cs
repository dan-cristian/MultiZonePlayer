...
namespace MultiZonePlayer
{
	...
	class WebServer
	{
		...
		private void ProcessRequest(HttpListenerContext context)
		{
			try
			{
				HTMLInterface.LastContext = context;
		...
		private String ServeDirectHtml(HttpListenerContext context, String requestServer, Metadata.ValueList resvalue, out String contentType, out byte[] binaryData)
		{
			...
			try
			{
				...
				else
				{
					...
					HTMLInterface.GenericReflect(HTMLInterface.Instance, ref result);
				}
			}
			catch (Exception ex)
			{
	...
	public class HTMLInterface
	{
		...
		public static HttpListenerContext LastContext;
		public static HTMLInterface Instance = new HTMLInterface();
        ...
        public String HTMLGetCmdValues(String methodname, String zoneid, String command, String htmldelimiter)
        {
            Metadata.ValueList vals = new Metadata.ValueList(Metadata.CommandSources.web);
        ...
        public MZPState HTMLMZPState(String methodname)
        {
        ...
        public Metadata.ZoneDetails HTMLZones(String methodname, String zoneid)
        {
            return MZPState.Instance.ZoneDetails.Find(x => x.ZoneId.Equals(Convert.ToInt16(zoneid)));
        }

        public Metadata.ZoneDetails HTMLFirstActiveZone(String methodname)
        {
        ...
        public String HTMLGetZoneStatusAsColor(String methodname, String zoneid, String activity)
        {
            Metadata.ZoneDetails zone = MZPState.Instance.ZoneDetails.Find(x => x.ZoneId.Equals(Convert.ToInt16(zoneid)));
